  ...
  switch (type) {
    case "double-column":
      return {
        ...
        projectName: "font-bold text-slate-800 break-words",
        role: "text-gray-600 mb-1 font-medium",
    ...
    case "simple":
      return {
        ...
        container: `${commonStyles.container}`,
        projectName: "font-bold text-[#4c1d95] break-words",
        role: "text-gray-600 mb-1 font-medium",
        timeRange: "text-gray-400 shrink-0",
      };
    case "modern":
      return {
        ...
        projectName: "font-bold text-gray-900",
    ...
    case "minimal":
      return {
        ...
        role: "font-medium text-gray-500",
    ...
    case "classic":
      return {
        ...
        projectName: "font-bold text-[#1a3a5c] break-words",
        role: "text-gray-600 mb-1 font-medium",
    ...
    case "fresh":
      return {
        ...
        role: "text-teal-700 mb-1 font-medium",
        timeRange: "text-gray-400 shrink-0",
        description: "text-gray-600 whitespace-pre-wrap mt-1",
      };
    case "sidebar-dark":
      return {
        ...
        projectName: "font-bold text-[#1f2d3d]",
        role: "text-gray-500 mb-1 font-medium",
        timeRange: "text-gray-400 shrink-0",
        description: "text-gray-600 whitespace-pre-wrap mt-1",
      };
    case "default":
    default:
      return {
        ...
        projectName: "font-bold text-gray-900 break-words",
        role: "text-primary-600 mb-1 font-medium",
        timeRange: "text-gray-400 shrink-0",
      };
  }
};
