    ...
    <a-layout-content>
      ...
      <div class="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-[80px] pt-6 pb-2">
        <a-breadcrumb separator=">">
          <a-breadcrumb-item>
            <router-link to="/" class="text-[#8c8c8c] hover:text-[#1677ff] transition-colors">首页</router-link>
          </a-breadcrumb-item>
      ...
      <!-- Header Section -->
      <div class="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-[80px] py-12 text-center">
...
const templates = ref<ResumeTemplate[]>([
  ...
  },
  {
    id: '3',
    name: '创意设计风',
    previewImage: 'https://placehold.co/800x500/FFF1F2/E11D48?text=Creative+Design',
    category: '设计岗',
    usedCount: 2100,
  ...
  },
  {
    id: '4',
    name: '商务精英版',
    previewImage: 'https://placehold.co/800x500/F8FAFC/475569?text=Business+Elite',
    category: '运营岗',
    usedCount: 4500,
