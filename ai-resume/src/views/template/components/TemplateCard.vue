  ...
  >
    ...
    <div class="relative w-full aspect-[16/10] overflow-hidden bg-gray-100">
      ...
      <img
        ...
        :src="fullImageUrl(template.previewImage)"
        :alt="template.name"
    ...
    <div class="p-6 bg-white flex flex-col flex-1 justify-between gap-4">
      ...
      <div class="flex flex-col gap-2.5">
        ...
        <!-- Stats row -->
        <div
          class="flex items-center justify-between text-[#8c8c8c] text-[14px]"
        >
...
const fullImageUrl = (url: string): string => {
  return import.meta.env.VITE_DEFAULT_AVATAR + url;
};
</script>
